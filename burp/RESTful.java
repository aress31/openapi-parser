...
public class RESTful {
	...
	public RESTful(String swagger, Info info, String host, String basePath, List<String> schemes, JsonObject paths, JsonObject definitions) {
		this.swagger = swagger;
		this.info = info;
		this.host = host;
		this.basePath = basePath;
...
>>>>>>> origin/master:burp/RESTful.java
}